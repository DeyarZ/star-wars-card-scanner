            ...
            ZStack {
                ...
                VStack(spacing: 0) {
                                    ...
                                    ZStack {
                                        ...
                                        RoundedRectangle(cornerRadius: 10)
                                            ...
                                            .overlay(
                                                VStack {
                                                    ...
                                                    Spacer()
                                                    StarWarsIcon(name: .jedi, size: geometry.size.height * 0.025)
                                        ...
                                        Rectangle()
                                            .fill(
                                                LinearGradient(
                                                    colors: [
                                                        Color.starWarsYellow.opacity(0.5),
                                            ...
                                            .blur(radius: 1)
                                            .shadow(color: Color.starWarsYellow, radius: 15)
                                            .opacity(scanLineOpacity)
                                            .offset(y: scanAnimation ? geometry.size.height * 0.088 : -geometry.size.height * 0.088)
                                    }
                                    
                                    Text("SCANNING...")
                                        .font(.starWarsDisplay(min(geometry.size.height * 0.015, 12)))
                    ...
                    VStack(spacing: geometry.size.height * 0.025) {
                        ...
                        // Body text
                        Text("Simply point your camera at any Star Wars card. Our AI instantly recognizes the card, provides market prices, and grades its condition.")
